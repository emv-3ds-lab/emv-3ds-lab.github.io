...
| EMV 3DS v2.4.0 (DRAFT 1) | In progress | Tracking [DSB 330](https://www.emvco.com/emv-technologies/3-d-secure/); comment period ends 1 July 2026 |
...
```bash
# 1. Clone
git clone https://github.com/emv-3ds-lab/emv-3ds-lab.github.io.git
cd emv-3ds-lab.github.io

# 2. Install (Node 20 LTS or newer is required)
npm install
...
90-day disclosure window, the GPG key, and the scope of what counts
as a reportable issue.
...
> EMV 3-D Secure Protocol Lab (2026). *EMV 3-D Secure Protocol Lab*
> (Version 0.1.0) [Software]. https://github.com/emv-3ds-lab/emv-3ds-lab.github.io
...
@software{emv_3ds_protocol_lab_2026,
  author = {{EMV 3-D Secure Lab Maintainers}},
...
For a long-term-stable identifier, the project is also published on
Zenodo (a DOI will appear here once a tagged release exists).
